...
class ParkingApi {
  ...
  ///
  /// * [String] timezone:
  ///   The IANA timezone to be used if not provided in both start_date and end_date. E.g., 'America/Vancouver'
  Future<Response> getParkingLotAvailableStallsWithHttpInfo(String parkingLotId, String stallType, DateTime startDate, DateTime endDate, { String? timezone, }) async {
  ...
  /// * [String] timezone:
  ///   The IANA timezone to be used if not provided in both start_date and end_date. E.g., 'America/Vancouver'
  Future<List<ParkingLotAvailableStallsV1>?> getParkingLotAvailableStalls(String parkingLotId, String stallType, DateTime startDate, DateTime endDate, { String? timezone, }) async {
    final response = await getParkingLotAvailableStallsWithHttpInfo(parkingLotId, stallType, startDate, endDate,  timezone: timezone, );

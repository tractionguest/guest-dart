...
class EmailTemplatesApi {
  ...
  /// * [String] include:
  ///   A list of comma-separated related models to include
  Future<PaginatedEmailTemplatesListV1?> getEmailTemplates({ int? limit, int? offset, String? include, }) async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'PaginatedEmailTemplatesListV1',) as PaginatedEmailTemplatesListV1;

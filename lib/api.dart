...
part 'model/assigned_stall_v1.dart';
...
part 'model/paginated_parking_lots_list_v1.dart';
part 'model/paginated_parking_stall_types_list_v1.dart';
part 'model/paginated_parking_stalls_list_v1.dart';
...
part 'model/parking_lot_available_stalls_v1.dart';
part 'model/parking_lot_v1.dart';
part 'model/parking_stall_v1.dart';

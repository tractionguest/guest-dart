...
class InviteV1 {
  ...
  bool operator ==(Object other) => identical(this, other) || other is InviteV1 &&
     ...
     other.assignedStall == assignedStall &&
  ...
  int get hashCode =>
    ...
    (assignedStall == null ? 0 : assignedStall!.hashCode) +
    (lastName == null ? 0 : lastName!.hashCode) +
    (firstName == null ? 0 : firstName!.hashCode) +
    (groupVisit == null ? 0 : groupVisit!.hashCode);

  @override
  String toString() => 'InviteV1[id=$id, registration=$registration, mobileNumber=$mobileNumber, email=$email, endDate=$endDate, inviteWatchlist=$inviteWatchlist, hosts=$hosts, watchlistColour=$watchlistColour, location=$location, startDate=$startDate, assignedStall=$assignedStall, lastName=$lastName, firstName=$firstName, groupVisit=$groupVisit]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (assignedStall != null) {
      _json[r'assigned_stall'] = assignedStall;
    }
    if (lastName != null) {
  ...
  static InviteV1? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return InviteV1(
        ...
        assignedStall: AssignedStallV1.fromJson(json[r'assigned_stall']),

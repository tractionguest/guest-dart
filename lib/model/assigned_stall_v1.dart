...
class AssignedStallV1 {
  ...
  AssignedStallV1({
    ...
    required this.computedStallNumber,
    this.range,
  });
  ...
  /// The computed number of the assigned parking stall along with the pre and post fix, if any.
  String computedStallNumber;
  ...
  bool operator ==(Object other) => identical(this, other) || other is AssignedStallV1 &&
     ...
     other.computedStallNumber == computedStallNumber &&
     other.range == range;
  ...
  int get hashCode =>
    ...
    (stallType.hashCode) +
    (computedStallNumber.hashCode) +
    (range == null ? 0 : range!.hashCode);

  @override
  String toString() => 'AssignedStallV1[id=$id, parkingStallId=$parkingStallId, parkingLotName=$parkingLotName, parkingLotId=$parkingLotId, stallNumber=$stallNumber, stallType=$stallType, computedStallNumber=$computedStallNumber, range=$range]';
  ...
  Map<String, dynamic> toJson() {
    final _json = <String, dynamic>{};
      ...
      _json[r'computed_stall_number'] = computedStallNumber;
    if (range != null) {
      _json[r'range'] = range;
    }
    return _json;
  ...
  static AssignedStallV1? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return AssignedStallV1(
        ...
        computedStallNumber: mapValueOfType<String>(json, r'computed_stall_number')!,

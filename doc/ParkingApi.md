...
[**getParkingStallTypes**](ParkingApi.md#getparkingstalltypes) | **GET** /parking_lots/{parking_lot_id}/parking_stalls/stall_types | Get stall types of parking lot
...
# **getParkingStallTypes**
> PaginatedParkingStallTypesListV1 getParkingStallTypes(parkingLotId, limit, offset)
...
try {
    final result = api_instance.getParkingStallTypes(parkingLotId, limit, offset);
    print(result);
} catch (e) {
    print('Exception when calling ParkingApi->getParkingStallTypes: $e\n');
}
```
...
[**PaginatedParkingStallTypesListV1**](PaginatedParkingStallTypesListV1.md)

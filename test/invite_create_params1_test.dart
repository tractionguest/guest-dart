...
// tests for InviteCreateParams1
void main() {
  var instance = new Pet();

  group('test InviteCreateParams1', () {
    ...
    // bool onPremise (default value: null)
    test('to test the property `onPremise`', () async {
      // TODO
    });

    // List<NotificationTrigger1> notificationTriggers (default value: [])

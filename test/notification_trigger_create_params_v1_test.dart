...
// tests for NotificationTriggerCreateParamsV1
void main() {
  // final instance = NotificationTriggerCreateParamsV1();

  group('test NotificationTriggerCreateParamsV1', () {
    ...
    // List<String> notificationGroups (default value: const [])
